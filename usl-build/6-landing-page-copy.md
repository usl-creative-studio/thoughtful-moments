...
**User:** him
**Payer or approver:** same as user. She is the beneficiary and never sees the purchase.
**Budget owner and approval dependency:** him; none
**Audience path:** same-person user/payer, with a beneficiary lens: speak to him, describe her
**Desirability rubric:** Pull. He reaches for the identity of the attentive partner and her reaction; the drift is the undertone.
**Caps applied, status, and paid-traffic readiness:** no caps. Paid-traffic readiness: Test only. This page is the Stage 2 experiment (30 days, ~$1,500 capped reach, noindex). No paid-launch recommendation is made here.
**Traffic source and visitor state:** founders' warm network with a forward-to-one-man ask, then capped paid social in Dallas. Problem-aware, solution-unaware.
**Selected archetype:** service-led with an editorial opening (hero direction C, tension-led)
**Primary action:** Hold a slot ($500 deposit via Stripe Checkout)
**Evidence basis:** reasoned. 0 buyer conversations (deferred by user on 2026-09-11). Founder direct experience. Category research from Stage 1 and this session.
**Date:** 2026-09-11
...
**User decision:** hold a slot, or leave his details for a plan.
**Payer decision:** same as user.
**Role-specific actions or page routes:** one page; one primary CTA (Hold a slot), one secondary (Tell Us About Her).

| Order | Module | Decision-maker | Visitor question | Evidence or artifact |
|---|---|---|---|---|
| 1 | Decision zone | Same person | What is this, and is it for me? | Prepared room photograph (placeholder, then documentary); price; qualifier line |
| 2 | The situation | Same person | Do they understand my life? | Manifesto, cut to four sentences |
...
Above the first scroll on mobile: the situation line, the promise, the price, the CTA. The qualifier sits last so the wrong visitor leaves without reading further.
...
**Reader relationship:** a friend who has done this before, talking to him, about her
**Primary reader:** him; same-person user and payer
**Payer register when separate:** not applicable
**Three sentences this brand could say:**
1. "You love her. That was never the question." (manifesto)
2. "You give the massage. We do everything else." (offer)
3. "Everything else you can buy her is a function of your wealth, not your care." (founder)
**Two sentences it would never say:**
1. "An unforgettable luxury experience, curated just for you."
2. "Reignite the spark tonight!"
**Vocabulary to use:** her, you, the night, the call, the room, the slot, by hand, gone before she is home, the morning after, done
**Vocabulary to avoid:** luxury, curated, elevated, unforgettable, bespoke, spa, kit, package, spark, "experience" as a noun where a plainer word exists
**Cadence:** short declaratives, second person, one idea per line; one longer sentence allowed in the situation
**Humor:** dry, rare, never at his expense
**Conviction:** plain and high; the page states, it does not argue
**Restraint:** no exclamation marks, no superlatives, no justification of the price
**Punctuation and casing:** sentence case, full stops in headlines, no ALL CAPS

Language rule: "slot" is the thing he holds, "booking" is the monthly limit, "night" is the evening itself.

---

## 3. FINAL PAGE COPY

### Module 1: Decision zone
...
### Module 2: The situation

**Job:** recognition.
**Paired proof or artifact:** none. Type scale is the transition.

You love her, and she knows it. She also knows you have been out the door at six and home at nine for most of this year. Money is easy for you now, which is why the necklace lands a little softer each time. What she has not had in a while is an evening where your attention was the whole point.

### Module 3: How the night works

**Job:** what actually happens, and what do I have to do.
**Paired proof or artifact:** numbered sequence; step 4 in the accent colour.

**How the night works**

**1. The planning call.** Twenty minutes, within two days of your deposit. We ask about her: what she loves, what she cannot eat, the date, and how you will get her out of the house for an afternoon. We draft the card with you, in your words. Once the date is confirmed, your deposit becomes the first part of the price.
...
### Module 4: The part that has to be yours

**Job:** will I be awkward. Objection 1. Carries the dream outcome as his intent, not our promise.
**Paired proof or artifact:** one cue card rendered in code from the copy below.

**The part that has to be yours**

Everything on this page could be done by someone else, except one thing. The moment you are after, when she realises you did this, only exists if the hands are yours.

So we make sure you are not guessing. On the call, we walk through the massage step by step. Two weeks out, you get numbered cue cards and a five-minute video to watch the night before. On the night, the cards sit beside you. Twelve of them, one move each, in order. You do not have to remember anything. You just have to be there, with her, and nowhere else.

*Cue card artifact:*

> *Card 4 of 12*
> **Shoulders.** Both hands flat, thumbs either side of her spine. Slow, from the neck down to the shoulder blades. Six times. Slower than feels natural.
> *Ask her: "Where do you carry the week?"*

(The final twelve-card copy is a build task for the founder; this card is the shape and is the one shown on the page.)
...
**The Morning After, Handled.** We come back and take everything away.
**Our Discretion Promise.** No photos. Nobody sees us arrive or leave. What we know about her stays with the night.

**What it is not**

Nobody else touches her. There is no therapist. Nothing arrives in a box for you to assemble. The night is yours; the hours around it are ours.
...
**Our commitment.** If the room, the food or the flowers are not what we agreed on the call, you do not pay for the night.
...
### Module 8: From Irewole

**Job:** who is behind this. Drafted from the founder's own words; the founder edits before publication.
**Paired proof or artifact:** signature in the handwritten face (its third and last appearance). No photograph until one exists.
...
### Module 9: Closing action and Tell Us About Her

**Job:** the decision again, and a way in for men not ready.
**Paired proof or artifact:** the form. The fifth question tests the effort thesis in the open.

**Her date is coming.**

Five bookings a month. $500 holds your slot, refundable until we confirm your date.
...
- Her birthday or your anniversary: [date]
- Where you live: [Dallas neighbourhood or ZIP]
- Three things she loves: [text]
- One thing she has said about you lately: [text]
- Would you give her the massage yourself? [Yes / I would want to, but I am nervous / No]
- Your email: [email]
...
**Your slot is held.** We will email you within two days to book the planning call. Your $500 is fully refundable until we confirm your date on that call.

**After the form:**
**Thank you. We will write back within two days** with a plan for the night and the price.

**Deposit confirmation email (Resend):** subject "Your slot is held". Body: the two-day promise, the refund terms in one line, a request for two or three windows for the call, signed by the founders.
...
**Authored-copy score:** 17/18. Source traceability 2; competitor replacement 2; specificity 2; cadence 2; vocabulary 2; claim-to-proof fit 2; objection fidelity 1 (objections are reasoned, in the founder's expected order, not observed from buyers); action clarity 2; decision-role coverage 2 (same person, stated explicitly, no approval path invented).
...
## 6. MARKET EVIDENCE AND SOURCES

| # | Public claim or decision supported | Source URL | Date checked |
|---|---|---|---|
| 1 | Dallas premium in-home category repeats "luxury, unforgettable, elevated, curated", hides prices, uses food photography and chef credentials, inquiry-to-call-to-estimate flow, two weeks' notice, deposit plus balance (conventions refused or kept) | https://www.chefinheelz.com/ ; https://chefxoxo.com/private-chef-dallastx ; https://thepolishedchef.com/locations/private-chef-dallas/ ; https://www.chefderricka.com/private-dining-services ; https://culinaryindulgence.com/ | 2026-09-11 |
| 2 | Dallas neighbour for the price: Rami Raw private four-course dinner, $2,500 minimum; penthouse experience $5,000 minimum (context only; not used on the page) | https://ramiraw.com/ | 2026-09-11 |
| 3 | Deposit-plus-balance is a familiar Dallas pattern (The Busy Kitchen: $199 deposit, balance on the day) | https://thebusykitchendfw.com/products/the-private-chef-experience | 2026-09-11 |
| 4 | Stripe Checkout Session can be created from a Next.js Server Action (hosted or embedded) | https://docs.stripe.com/checkout/quickstart?client=next ; https://docs.stripe.com/checkout/embedded/quickstart.md | 2026-09-11 |
| 5 | Public language on effort versus money: "given my best to others in my work, leaving my leftovers for my wife" (inference source for Module 2, not quoted) | https://www.markmerrill.com/how-to-show-love-to-your-spouse/ | 2026-09-11 (article 2022) |
| 6 | Gifts read as proof of attention; people want to feel considered (inference source, not quoted) | https://menlifestylehub.com/husband-tried-to-pass-off-a-gift-for-himself-as-a-mothers-day-present-wife-turns-to-reddit-for-opinions/ | 2026-09-11 |

**Still unverified:** Reddit buyer language (fetch blocked); the food partner and its terms; the waiver and commitment wording (professional review); the reference sites named for craft (Aesop, Le Labo, Kinfolk) were not fetched this session and are named for their transferable decisions only.
